  ...
  return (
    ...
    {/* Header */}
      ...
      {/* left Welcome-Container */}
        ...
        <div className='font-medium text-sm sm:text-base text-gray-600   mt-2' >Sign Up to continue organizing your tasks  <br />and achieve more every day</div>
        </div>
        ...
        <div className='font-bold sm:text-xl md:text-2xl lg:text-3xl font-gray-800   mt-5' >Sign Up to <span className='text-blue-500'>FocusList</span></div>
    ...
    />
            ...
            {/* Sign Up-btn */}
            <div className="  Sign Up-btn mt-6">
                
                <SignUpBtn 
                onClick={handleSignup}
                fullWidth={true} icon={true} text='Sign Up'
                ...
                <div className="dont text-center mb-5">
                    <p className='text-gray-600 text-sm mt-6'>You have already account ! <span className='text-blue-500 cursor-pointer'>
                        <Link
                        to="/"
                        >
                        Login
