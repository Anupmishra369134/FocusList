         ...
         <button className='md:flex w-48 bg-blue-600 rounded-md text-white px-4 py-3 gap-3 font-semibold hidden text-center hover:bg-blue-800 mt-6 '>
            ...
            {/* <div className="mini mt-6 px-4 space-y-2 "> */}
               ...
               <button onClick={()=> setColor("Change")}
                className='md:flex w-48 bg-blue-50 border mt-5 border-blue-800 outline-none rounded-md text-blue-700 px-4 py-3 gap-4 font-semibold hidden items-center hover:bg-blue-300 '>
                <MdOutlineDashboard className='text-xl text-blue-700 '/>
                Dashboard
            </button>
...
<div className='flex-row w-full mt-6 justify-between'>
    <h1 className='font-bold mb-2 md:mt-3 md:mb-6 text-2xl'>Overview</h1>
<div className="grid grid-cols-1 md:grid-cols-3  w-2/3 gap-4   ">
  ...
  <div className="bg-yellow-100 p-5 rounded-xl items-center">
    <h3>Pending</h3>
    <p className="text-3xl font-bold">
      {pendingTasks}
    </p>
